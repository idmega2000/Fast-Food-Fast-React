			...
			<div className="main-im-cov">
				...
				<div id="front-content-cover">
					...
					<div id="arrowP" className="arrow bounce">
						<a id="arrowAnchor" href="#BrandActivities"><p className="fa fa-arrow-down fa-2x" href="#thisss"></p></a>
					</div>
				</div>

				<div className="brand-menu" id="thisss">
					<div className="brand-activities" id="BrandActivities">
						<div className="  row col-3 brand-act-cov">
							...
							<p> You want to have a taste of the food that makes your day bloosom, Order your favourite food from the best restaurants
								in town.</p>
						</div>
						<div className=" row col-3 brand-act-cov">
							<div className="brand-act-images">
							...
							<p>want your your ordered food to get to you in not time, we've got your back. we make sure the food is in the proper
						...
						<div className=" row col-3 brand-act-cov">
							...
							<p> You have an evnet or meeting coming up, order your food in advance. This allow you to focus on the meeting and leave
					...
					<div className="order-meals">
						<div className="row col-4 order-a-meal">
							<div className="red-order-meals">
								...
								<div>
									<a href="pages/fastfood.html" className="anchor-button andchor-full-width">Order</a>
								</div>
							</div>
						</div>
						<div className=" row col-4 order-a-meal">
							<div className="red-order-meals">
								...
								<div>
									<a className="anchor-button andchor-full-width" href="pages/fastfood.html">Order</a>
								</div>
							</div>
						</div>
						<div className="row col-4 order-a-meal">
